...
class DetectionData:
    ...
    per-frame arrays (`occlusions`, `frames`, `bboxes_norm`) are aligned to `frame_indices`, the
    sorted union of amodal- and visible-annotated frames for the target."""
    ...
    def initialize_target(self, video_name: str, person_id: int, frame_indices: NDArray[np.int64] | None = None):
