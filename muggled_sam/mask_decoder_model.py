...
class SAMV2MaskDecoder(nn.Module):
    """
    Simplified implementation of the 'mask-decoder' model/component 
    ...
    def forward(
        ...
        Returns:
            mask_predictions, iou_predictions, object_pointers, object_score, iou_token_out, obj_token_out
            ...
            -> iou_token_out / obj_token_out are the encoded cls tokens that feed
               into the iou and object-score MLPs respectively. Shape: BxF
        ...
        if blank_promptless_output and (num_prompts == 0) and (mask_hint is None):
            ...
            blank_token = torch.zeros(batch_size_prompts, self.cls_iou_token.shape[-1],
                                      device=lowres_tokens.device, dtype=lowres_tokens.dtype)
            return mask_preds, iou_preds, obj_ptrs, obj_score, blank_token, blank_token
        ...
        return mask_preds, iou_preds, obj_ptrs, obj_score, iou_token_out, obj_token_out
