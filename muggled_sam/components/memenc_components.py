...
class MaskDownsampler(nn.Module):
    """
    Simplified implementation of the 'mask downsampler' 
    ...
    module of the same name which performs downsampling, 
    ...
    location for this functionality,
    """
...
class ConvNeXtBlock(nn.Module):
    """Slightly modified implementation of the 'CXBlock'
    ...
    def forward(self, imagelike_bchw: Tensor) -> Tensor:
        """Takes in an image-like tensor (shape BxCxHxW) and primarily mixes information among the channels.
        """
